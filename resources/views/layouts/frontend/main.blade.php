...
<head>
    ...
    <!-- Style CSS -->
    {{--  <link rel="stylesheet" href="{{ asset('/assets/kz/bootstrap-4.5.0/css/custom/style-orange.css') }}">  --}}
    {{--  <link rel="stylesheet" href="{{ asset('/assets/kz/bootstrap-4.5.0/css/responsive-orange.css') }}">  --}}
    <link rel="stylesheet" href="/assets/kz/bootstrap-4.5.0/css/custom/style-blue.css">
    <link rel="stylesheet" href="/assets/kz/bootstrap-4.5.0/css/responsive-blue.css">
    ...
    <body class="box-bg">
        <div class="boxed-layout">
            <livewire:main.header></livewire:main.header>
            @yield('content')
           <livewire:main.newsletter></livewire:main.newsletter>
           <livewire:main.footer></livewire:main.footer>
        </div>
        <!-- Jquery JS -->
